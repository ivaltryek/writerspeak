...
if(isset($_GET['profile'])){
    ...
    $query = "select * from `googleloginusers` where `username` = '".$_GET['profile']."' ";
		...
		<div class="col-md-3">
			<div class="profile-sidebar">
				...
				<div class="profile-userpic">
                    <img src="<?php echo $profilepic ?>"  class="img-responsive" alt="Error">
                	</div>
				<!-- END SIDEBAR USERPIC -->
				<!-- SIDEBAR USER TITLE -->
                ...
                <?php
              $post_query = "select * from `lyrics` where author = '".$_GET['profile']."' ";
