...
<head>
  <script type="text/javascript" src = "../boot/js/jquery-3.3.1.min.js"></script>
    ...
    <title>WritersPeak|UpdateUser</title>
    ...
    <div class="col-sm-3 my-1">
      ...
      <div class ="container">
        <div class="row">
          ...
          <input type="text" maxlength="14" id="username" disabled onkeyup="checkUsername()"  name="username" minlength="3" class="form-control" id="inlineFormInputGroupUsername"  />
          </div><br>
